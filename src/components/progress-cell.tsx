...
import { renameProgressValue, updateTodo } from "@/lib/todoSlice";
import {
        ...
        <DropdownMenuContent align="start" className="w-56">
          {options.map((p) => (
            ...
            >
              <span
                className={cn(
                  "flex-1 rounded-md px-1.5 py-0.5 text-xs truncate",
                  colorFor(p),
                )}
              >
                {p}
                ...
                <>
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      ...
                      if (progress === p) setProgress(null);
                    }}
          ...
          {progress && (
            <>
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => setProgress(null)}>
                Clear
              </DropdownMenuItem>
            </>
          )}
