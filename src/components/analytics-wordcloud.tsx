...
const STOPWORDS = new Set([
  ...
  "it", "its", "we", "you", "your", "they", "them", "their", "i", "my", "me",
  "if", "so", "not", "no", "yes", "than", "then", "into", "out", "over", "up",
  "down", "about", "after", "before", "between", "such", "can", "will", "just",
  "also", "any", "some", "all", "more", "most", "much", "many", "very", "too",
  "only", "own", "same", "other", "another", "each", "every", "both", "few",
  "should", "would", "could", "may", "might", "must", "shall", "while", "when",
  "where", "what", "who", "how", "why", "which", "via",
])
